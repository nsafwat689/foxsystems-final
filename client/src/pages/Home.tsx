...
export default function Home() {
  ...
  const services = [
    ...
    { icon: Server, title: t.domainServices, desc: t.domainDesc, category: "infrastructure", image: "/hero-tech.jpg.jpg.jpg" },
    { icon: Globe, title: t.websites, desc: t.websitesDesc, category: "software", image: "/hero-tech.jpg.jpg.jpg" },
